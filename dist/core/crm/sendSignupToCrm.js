...
exports.sendSignupToCrm = sendSignupToCrm;
const zohoTokenManager_1 = require("./zohoTokenManager");
...
async function sendSignupToCrm(payload) {
    const accessToken = await (0, zohoTokenManager_1.getZohoAccessToken)();
